...
fasting_glucose_Dupuis_master = read.table(file = '~/scratch/principal_component_GWAS/all_traits_raw/MAGIC_FastingGlucose.txt', sep = '\t', header = TRUE)
fasting_insulin_Dupuis_master = read.table(file = '~/scratch/principal_component_GWAS/all_traits_raw/MAGIC_ln_FastingInsulin.txt', sep = '\t', header = TRUE)
homab_Dupuis_master = read.table(file = '~/scratch/principal_component_GWAS/all_traits_raw/MAGIC_ln_HOMA-B.txt', sep = '\t', header = TRUE)
homair_Dupuis_master = read.table(file = '~/scratch/principal_component_GWAS/all_traits_raw/MAGIC_ln_HOMA-IR.txt', sep = '\t', header = TRUE)
...
# fasting_glucose_Dupuis_master = read.table(file = '~/scratch/principal_component_GWAS/all_traits_raw/MAGIC_FastingGlucose.txt', sep = '\t', header = TRUE, nrows=100)
# fasting_insulin_Dupuis_master = read.table(file = '~/scratch/principal_component_GWAS/all_traits_raw/MAGIC_ln_FastingInsulin.txt', sep = '\t', header = TRUE, nrows=100)
# homab_Dupuis_master = read.table(file = '~/scratch/principal_component_GWAS/all_traits_raw/MAGIC_ln_HOMA-B.txt', sep = '\t', header = TRUE, nrows=100)
# homair_Dupuis_master = read.table(file = '~/scratch/principal_component_GWAS/all_traits_raw/MAGIC_ln_HOMA-IR.txt', sep = '\t', header = TRUE, nrows=100)
...
alzheimers = alzheimers_master[,c("variant_id","other_allele", "effect_allele", "n", "beta", "p_value")]

#body_mass_index: n
body_mass_index_master$n = rep(718734, nrow(body_mass_index_master))
body_mass_index = body_mass_index_master[,c("SNPNAME", "REF", "ALT", "n", "beta", "Pvalue")]

#chronic_inflammation: n
chronic_inflammation_master$n = rep(1002898, nrow(chronic_inflammation_master))
chronic_inflammation = chronic_inflammation_master[,c("variant_id", "other_allele", "effect_allele", "n", "beta", "p_value")]

#class_1_obesity: n
class_1_obesity_master$n = class_1_obesity_master$N_cases + class_1_obesity_master$N_controls
class_1_obesity = class_1_obesity_master[,c("MarkerName", "Allele2", "Allele1", "n", "beta", "P")]

#class_2_obesity: n

class_2_obesity_master$n = class_2_obesity_master$N_cases + class_2_obesity_master$N_controls
class_2_obesity = class_2_obesity_master[,c("MarkerName", "Allele2", "Allele1", "n", "beta", "P")]

#class_3_obesity: n
class_3_obesity_master$n = class_3_obesity_master$N_cases + class_3_obesity_master$N_controls
class_3_obesity = class_3_obesity_master[,c("MarkerName", "Allele2", "Allele1", "n", "beta", "P")]

#coronary_artery_disease: n/a
coronary_artery_disease = coronary_artery_disease_master[,c("variant_id", "other_allele", "effect_allele", "n", "beta", "p_value")]
...
extreme_body_mass_index = extreme_body_mass_index_master[,c("MarkerName", "Allele2", "Allele1", "n", "beta", "P")]
...
extreme_waist_hip_ratio = extreme_waist_hip_ratio_master[,c("MarkerName", "Allele2", "Allele1", "n", "beta", "P")]
...
extrinsic_epigenetic_age_acceleration = extrinsic_epigenetic_age_acceleration_master[,c("SNP", "metaA1", "metaA2", "n", "meta_b", "metaPval")]

#fasting_glucose: n
fasting_glucose_master$n = rep(58074, nrow(fasting_glucose_master))
fasting_glucose = fasting_glucose_master[,c("Snp", "other_allele", "effect_allele", "n", "BMIadjMainEffects", "BMIadjMainP")]

#fasting_insulin: n
fasting_insulin_master$n = rep(51750, nrow(fasting_insulin_master))
fasting_insulin = fasting_insulin_master[,c("Snp", "other_allele", "effect_allele", "n", "BMIadjMainEffects", "BMIadjMainP")]

#fasting_proinsulin: n
fasting_proinsulin_master$n = rep(10701, nrow(fasting_proinsulin_master))
fasting_proinsulin = fasting_proinsulin_master[,c("snp", "other_allele", "effect_allele", "n", "effect", "pvalue")]

#frailty_index: n
frailty_index_master$n = rep(175226, nrow(frailty_index_master))
frailty_index = frailty_index_master[,c("SNP", "ALLELE0", "ALLELE1", "n", "BETA", "P_BOLT_LMM")]

#hba1c: n
hba1c_master$n = rep(46368, nrow(hba1c_master))
hba1c = hba1c_master[,c("snp", "other_allele", "effect_allele", "n", "effect", "pvalue")]
...
healthspan = healthspan_master[,c("SNPID", "RA", "EA", "n", "beta", "p_value")]

#high_density_lipoprotien: n/a
high_density_lipoprotien = high_density_lipoprotien_master[,c("rsID", "REF", "ALT", "N", "EFFECT_SIZE", "pvalue")]

#homab: n
homab_master$n = rep(58074, nrow(homab_master))
homab = homab_master[,c("Snp", "other_allele", "effect_allele", "n", "BMIadjMainEffects", "BMIadjMainP")]

#homair: n
homair_master$n = rep(51750, nrow(homair_master))
homair = homair_master[,c("Snp", "other_allele", "effect_allele", "n", "BMIadjMainEffects", "BMIadjMainP")]

#income_master: n
income_master$n = rep(286301, nrow(income_master))
income = income_master[,c("SNP", "Non_effect_Allele", "Effect_Allele", "n", "Beta", "P")]

#intelligence: n
intelligence_master$n = rep(269867, nrow(intelligence_master))
intelligence = intelligence_master[,c("variant_id", "other_allele", "effect_allele", "n", "beta", "p_value")]
...
intrinsic_epigenetic_age_acceleration = intrinsic_epigenetic_age_acceleration_master[,c("SNP", "metaA1", "metaA2", "n", "meta_b", "metaPval")]

#lacunar_stroke: n
lacunar_stroke_master$n = rep(254959, nrow(lacunar_stroke_master))
lacunar_stroke = lacunar_stroke_master[,c("variant_id", "other_allele", "effect_allele", "n", "beta", "p_value")]
...
low_density_lipoprotien = low_density_lipoprotien_master[,c("rsID", "REF", "ALT", "N", "EFFECT_SIZE", "pvalue")]

#overweight: n
overweight_master$n = overweight_master$N_cases + overweight_master$N_controls
overweight = overweight_master[,c("MarkerName", "Allele2", "Allele1", "n", "beta", "P")]

#percieved_age: n/a
percieved_age = percieved_age_master[,c("SNP", "ALLELE0", "ALLELE1", "N_EFFECTIVE", "LOG_OR", "P_BOLT_LMM_INF")]

#serum_urate_concentration: n
serum_urate_concentration_master$n = rep(110347, nrow(serum_urate_concentration_master))
serum_urate_concentration = serum_urate_concentration_master[,c("variant_id", "other_allele", "effect_allele", "n", "beta", "p_value")]

#telomere_length: n
telomere_length_master$n = rep(472174, nrow(telomere_length_master))
telomere_length = telomere_length_master[,c("variant_id", "other_allele", "effec_allele", "n", "beta", "p_value")]

#triglyceride: n/a
triglyceride = triglyceride_master[,c("rsID", "REF", "ALT", "N", "EFFECT_SIZE", "pvalue")]

#two_hour_glucose: n
two_hour_glucose_master$n = rep(15234, nrow(two_hour_glucose_master))
two_hour_glucose = two_hour_glucose_master[,c("snp", "other_allele", "effect_allele", "n", "effect", "pvalue")]
...
waist_hip_ratio = waist_hip_ratio_master[,c("rsid", "Other_Allele", "Tested_Allele", "N", "BETA", "P")]

#atherosclerosis: n/a
atherosclerosis = atherosclerosis_master[,c("variant_id", "other_allele", "effect_allele", "N", "beta", "p_value")]

#leucine: n/a
leucine = leucine_master[,c("ID", "NEA", "EA", "n_samples", "beta", "p.value")]

#isoleucine: n/a
isoleucine = isoleucine_master[,c("ID", "NEA", "EA", "n_samples", "beta", "p.value")]

#valine: n/a
valine = valine_master[,c("ID", "NEA", "EA", "n_samples", "beta", "p.value")]

#free_cholesterol_in_very_large_hdl: n/a
free_cholesterol_in_very_large_hdl = free_cholesterol_in_very_large_hdl_master[,c("ID", "NEA", "EA", "n_samples", "beta", "p.value")]

#free_cholesterol_in_large_hdl: n/a
free_cholesterol_in_large_hdl = free_cholesterol_in_large_hdl_master[,c("ID", "NEA", "EA", "n_samples", "beta", "p.value")]

#phospholipid_in_very_large_hdl: n/a
phospholipid_in_very_large_hdl = phospholipid_in_very_large_hdl_master[,c("ID", "NEA", "EA", "n_samples", "beta", "p.value")]

#phospholipid_in_large_hdl: n/a
phospholipid_in_large_hdl = phospholipid_in_large_hdl_master[,c("ID", "NEA", "EA", "n_samples", "beta", "p.value")]

#triglyceride_in_very_large_vldl: n/a
triglyceride_in_very_large_vldl = triglyceride_in_very_large_vldl_master[,c("ID", "NEA", "EA", "n_samples", "beta", "p.value")]

#triglyceride_in_large_vldl: n/a
triglyceride_in_large_vldl = triglyceride_in_large_vldl_master[,c("ID", "NEA", "EA", "n_samples", "beta", "p.value")]
...
#fasting_glucose_Dupuis: n
fasting_glucose_Dupuis_master$n = rep(46186, nrow(fasting_glucose_Dupuis_master))
fasting_glucose_Dupuis = fasting_glucose_Dupuis_master[,c("snp", "other_allele", "effect_allele", "n", "effect", "pvalue")]

#fasting_insulin_Dupuis: n
fasting_insulin_Dupuis_master$n = rep(38244, nrow(fasting_insulin_Dupuis_master))
fasting_insulin_Dupuis = fasting_insulin_Dupuis_master[,c("snp", "other_allele", "effect_allele", "n", "effect", "pvalue")]

#homab_Dupuis: n
homab_Dupuis_master$n = rep(36466, nrow(homab_Dupuis_master))
homab_Dupuis = homab_Dupuis_master[,c("snp", "other_allele", "effect_allele", "n", "effect", "pvalue")]

#homair_Dupuis: n
homair_Dupuis_master$n = rep(36946, nrow(homair_Dupuis_master))
homair_Dupuis = homair_Dupuis_master[,c("snp", "other_allele", "effect_allele", "n", "effect", "pvalue")]
...
#==================
new_column_names_ldsc_beta = c("SNP", "A2", "A1",  "N", "BETA", "P")
new_column_names_ldsc_or = c("SNP", "A2", "A1",  "N", "OR", "P")
new_column_names_ldsc_log_or = c("SNP", "A2", "A1",  "N", "LOG_ODDS", "P")
...
colnames(fasting_glucose_Dupuis) = new_column_names_ldsc_beta
colnames(fasting_insulin_Dupuis) = new_column_names_ldsc_beta
colnames(homab_Dupuis) = new_column_names_ldsc_beta
colnames(homair_Dupuis) = new_column_names_ldsc_beta
...
fasting_glucose_Dupuis = fasting_glucose_Dupuis[!duplicated(fasting_glucose_Dupuis[,'SNP']),]
fasting_insulin_Dupuis = fasting_insulin_Dupuis[!duplicated(fasting_insulin_Dupuis[,'SNP']),]
homab_Dupuis = homab_Dupuis[!duplicated(homab_Dupuis[,'SNP']),]
homair_Dupuis = homair_Dupuis[!duplicated(homair_Dupuis[,'SNP']),]
...
print(max(fasting_glucose_Dupuis$N)) 
print(max(fasting_insulin_Dupuis$N)) 
print(max(homab_Dupuis$N)) 
print(max(homair_Dupuis$N))

write.table(alzheimers,'~/scratch/principal_component_GWAS/all_traits_preprocessed/alzheimers.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(body_mass_index,'~/scratch/principal_component_GWAS/all_traits_preprocessed/body_mass_index.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(chronic_inflammation,'~/scratch/principal_component_GWAS/all_traits_preprocessed/chronic_inflammation.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(class_1_obesity,'~/scratch/principal_component_GWAS/all_traits_preprocessed/class_1_obesity.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(class_2_obesity,'~/scratch/principal_component_GWAS/all_traits_preprocessed/class_2_obesity.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(class_3_obesity,'~/scratch/principal_component_GWAS/all_traits_preprocessed/class_3_obesity.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(coronary_artery_disease,'~/scratch/principal_component_GWAS/all_traits_preprocessed/coronary_artery_disease.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(extreme_body_mass_index,'~/scratch/principal_component_GWAS/all_traits_preprocessed/extreme_body_mass_index.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(extreme_waist_hip_ratio,'~/scratch/principal_component_GWAS/all_traits_preprocessed/extreme_waist_hip_ratio.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(extrinsic_epigenetic_age_acceleration,'~/scratch/principal_component_GWAS/all_traits_preprocessed/extrinsic_epigenetic_age_acceleration.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(fasting_glucose,'~/scratch/principal_component_GWAS/all_traits_preprocessed/fasting_glucose.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(fasting_insulin,'~/scratch/principal_component_GWAS/all_traits_preprocessed/fasting_insulin.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(fasting_proinsulin,'~/scratch/principal_component_GWAS/all_traits_preprocessed/fasting_proinsulin.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(frailty_index,'~/scratch/principal_component_GWAS/all_traits_preprocessed/frailty_index.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(hba1c,'~/scratch/principal_component_GWAS/all_traits_preprocessed/hba1c.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(healthspan,'~/scratch/principal_component_GWAS/all_traits_preprocessed/healthspan.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(high_density_lipoprotien,'~/scratch/principal_component_GWAS/all_traits_preprocessed/high_density_lipoprotien.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(homab,'~/scratch/principal_component_GWAS/all_traits_preprocessed/homab.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(homair,'~/scratch/principal_component_GWAS/all_traits_preprocessed/homair.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(income,'~/scratch/principal_component_GWAS/all_traits_preprocessed/income.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(intelligence,'~/scratch/principal_component_GWAS/all_traits_preprocessed/intelligence.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(intrinsic_epigenetic_age_acceleration,'~/scratch/principal_component_GWAS/all_traits_preprocessed/intrinsic_epigenetic_age_acceleration.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(lacunar_stroke,'~/scratch/principal_component_GWAS/all_traits_preprocessed/lacunar_stroke.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(low_density_lipoprotien,'~/scratch/principal_component_GWAS/all_traits_preprocessed/low_density_lipoprotien.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(overweight,'~/scratch/principal_component_GWAS/all_traits_preprocessed/overweight.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(percieved_age,'~/scratch/principal_component_GWAS/all_traits_preprocessed/percieved_age.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(serum_urate_concentration,'~/scratch/principal_component_GWAS/all_traits_preprocessed/serum_urate_concentration.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(telomere_length,'~/scratch/principal_component_GWAS/all_traits_preprocessed/telomere_length.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(triglyceride,'~/scratch/principal_component_GWAS/all_traits_preprocessed/triglyceride.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(two_hour_glucose,'~/scratch/principal_component_GWAS/all_traits_preprocessed/two_hour_glucose.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(type_2_diabetes,'~/scratch/principal_component_GWAS/all_traits_preprocessed/type_2_diabetes.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(waist_hip_ratio,'~/scratch/principal_component_GWAS/all_traits_preprocessed/waist_hip_ratio.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(atherosclerosis,'~/scratch/principal_component_GWAS/all_traits_preprocessed/atherosclerosis.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(leucine,'~/scratch/principal_component_GWAS/all_traits_preprocessed/leucine.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(isoleucine,'~/scratch/principal_component_GWAS/all_traits_preprocessed/isoleucine.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(valine,'~/scratch/principal_component_GWAS/all_traits_preprocessed/valine.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(free_cholesterol_in_very_large_hdl,'~/scratch/principal_component_GWAS/all_traits_preprocessed/free_cholesterol_in_very_large_hdl.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(free_cholesterol_in_large_hdl,'~/scratch/principal_component_GWAS/all_traits_preprocessed/free_cholesterol_in_large_hdl.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(phospholipid_in_very_large_hdl,'~/scratch/principal_component_GWAS/all_traits_preprocessed/phospholipid_in_very_large_hdl.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(phospholipid_in_large_hdl,'~/scratch/principal_component_GWAS/all_traits_preprocessed/phospholipid_in_large_hdl.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(triglyceride_in_very_large_vldl,'~/scratch/principal_component_GWAS/all_traits_preprocessed/triglyceride_in_very_large_vldl.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(triglyceride_in_large_vldl,'~/scratch/principal_component_GWAS/all_traits_preprocessed/triglyceride_in_large_vldl.txt',sep=" ",row.names=FALSE, quote=FALSE)


write.table(fasting_glucose_Dupuis,'~/scratch/principal_component_GWAS/all_traits_preprocessed/fasting_glucose_Dupuis.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(fasting_insulin_Dupuis,'~/scratch/principal_component_GWAS/all_traits_preprocessed/fasting_insulin_Dupuis.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(homab_Dupuis,'~/scratch/principal_component_GWAS/all_traits_preprocessed/homab_Dupuis.txt',sep=" ",row.names=FALSE, quote=FALSE)
write.table(homair_Dupuis,'~/scratch/principal_component_GWAS/all_traits_preprocessed/homair_Dupuis.txt',sep=" ",row.names=FALSE, quote=FALSE)
